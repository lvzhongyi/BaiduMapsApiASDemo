...
public class RoutePlanDemo extends Activity implements BaiduMap.OnMapClickListener,
    ...
    List<PlanNode> lists = Arrays.asList(
            PlanNode.withLocation(new LatLng(22.599688288006377,113.85659420092686)),
            PlanNode.withLocation(new LatLng(22.599688288006377,113.85659420092686)),
            PlanNode.withLocation(new LatLng(22.599688288006377,113.85659420092686)),
            PlanNode.withLocation(new LatLng(22.599688288006377,113.85659420092686)),
            PlanNode.withLocation(new LatLng(22.599688288006377,113.85659420092686)),
...
//        mBaidumap.clear();
        ...
        stNode = PlanNode.withLocation(new LatLng(22.599688288006377,113.85659420092686));
        enNode = PlanNode.withLocation(new LatLng(22.599688288006377,113.85642352288002));
